...
/*!********************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/react-rangeslider/lib/index.css ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var content = __webpack_require__(/*! !../../css-loader!./index.css */ "./node_modules/css-loader/index.js!./node_modules/react-rangeslider/lib/index.css");
...
function runSimulation() {
    return {
        type: exports.Actions.RUN_SIMULATION
    };
}
...
var Canvas = function () {
    ...
    _createClass(Canvas, [{
        ...
        key: "clearUpperRight",
        value: function clearUpperRight() {
            this.ctx.clearRect(501, 0, 299, 249);
        }
    }, {
        key: "clearLowerRight",
        value: function clearLowerRight() {
            this.ctx.clearRect(501, 251, 299, 249);
        }
    }, {
        key: "clearRegions",
        value: function clearRegions() {
            this.clearLeft();
...
/***/ "./src/js/canvas/pendulum_visualization.ts":
/*!*************************************************!*\
  !*** ./src/js/canvas/pendulum_visualization.ts ***!
  \*************************************************/
/*! no static exports found */
...
var PendulumVisualization = function (_canvas_1$default) {
    ...
    function PendulumVisualization(canvas, simulation) {
        _classCallCheck(this, PendulumVisualization);

        var _this = _possibleConstructorReturn(this, (PendulumVisualization.__proto__ || Object.getPrototypeOf(PendulumVisualization)).call(this, canvas));
    ...
    _createClass(PendulumVisualization, [{
        key: "initialize",
        ...
        value: function drawPhaseHistory() {
            ...
            this.clearUpperRight();
            for (var i = this.simulation.historySize; i > 0; i--) {
        ...
        key: "drawPhasePoint",
        value: function drawPhasePoint(theta, omega) {
            var current = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var canvas_1 = __webpack_require__(/*! ./canvas */ "./src/js/components/canvas.tsx");
var controls_1 = __webpack_require__(/*! ./controls */ "./src/js/components/controls.tsx");
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        key: "render",
        value: function render() {
            return React.createElement("div", null, React.createElement(canvas_1.default, null), React.createElement(controls_1.default, null));
        }
    }]);
...
var simulation_1 = __webpack_require__(/*! ../actions/simulation */ "./src/js/actions/simulation.ts");
var simulation_2 = __webpack_require__(/*! ../stores/simulation */ "./src/js/stores/simulation.ts");
var pendulum_visualization_1 = __webpack_require__(/*! ../canvas/pendulum_visualization */ "./src/js/canvas/pendulum_visualization.ts");
window.Module = {
    initialized: false,
    ...
    onRuntimeInitialized: function onRuntimeInitialized() {
        ...
        simulation_2.default.dispatch(simulation_1.runSimulation());
    }
};
...
var Canvas = function (_React$Component) {
    ...
    _createClass(Canvas, [{
        ...
        value: function componentDidUpdate(prevProps) {
            if (this.props.running) {
                if (this.state.model === undefined) {
                    var model = new window.Module.Pendulum(179 * Math.PI / 180);
                    ...
                    var animationID = simulation.start();
                    this.setState({
                        model: model,
        ...
        key: "render",
        value: function render() {
            return React.createElement("canvas", { id: "canvas", width: "800px", height: "500px" });
        }
    }]);
...
/***/ "./src/js/components/controls.tsx":
/*!****************************************!*\
  !*** ./src/js/components/controls.tsx ***!
  \****************************************/
/*! no static exports found */
...
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
var react_rangeslider_1 = __webpack_require__(/*! react-rangeslider */ "./node_modules/react-rangeslider/lib/index.js");
var simulation_1 = __webpack_require__(/*! ../actions/simulation */ "./src/js/actions/simulation.ts");
...
var Controls = function (_React$Component) {
    ...
    _createClass(Controls, [{
        ...
        value: function handleChange(value) {
            this.props.dispatch(simulation_1.changeDamping(Number(Math.round(Number(value + 'e2')) + 'e-2')));
        }
    }, {
        key: "render",
        value: function render() {
            ...
            return React.createElement("div", null, React.createElement(react_rangeslider_1.default, { min: 0, max: 1, step: 0.1, tooltip: false, value: damping, onChange: this.handleChange.bind(this) }), damping);
        }
    }]);
...
exports.default = react_redux_1.connect(mapStateToProps)(Controls);
...
var react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
var simulation_1 = __webpack_require__(/*! ./stores/simulation */ "./src/js/stores/simulation.ts");
var app_1 = __webpack_require__(/*! ./components/app */ "./src/js/components/app.tsx");
ReactDOM.render(React.createElement(react_redux_1.Provider, { store: simulation_1.default }, React.createElement(app_1.default, null)), document.getElementById('root'));

/***/ }),

/***/ "./src/js/reducers/simulation.ts":
/*!***************************************!*\
  !*** ./src/js/reducers/simulation.ts ***!
  \***************************************/
/*! no static exports found */
...
function state() {
    ...
    switch (action.type) {
        case simulation_1.Actions.RUN_SIMULATION:
...
Object.defineProperty(exports, "__esModule", { value: true });
var redux_1 = __webpack_require__(/*! redux */ "./node_modules/redux/es/redux.js");
var simulation_1 = __webpack_require__(/*! ../reducers/simulation */ "./src/js/reducers/simulation.ts");
exports.default = redux_1.createStore(simulation_1.default);
